...
export default class Graphics3d {
  ...
  constructor(args) {
    ...
    this.cameraRot= Math.PI-this.player.rotation.y + 90*Math.PI/180
...
tex.wrapS = tex.wrapT = THREE.RepeatWrapping;
  ...
  update(opponents, player,delta,serverUpdates) {
    ...
    this.player.rotateTires(player.speed*delta);
    this.player.turnWheels(player.turnAmount)
    
    this.goalDir=player.dir
    ...
    */
    ...
    for (const oppData of opponents) {
      ...
      opp.rotateTires(oppData.speed*delta);
      opp.turnWheels(oppData.turnAmount)
      } else 
